    ...
    <div className="min-h-screen bg-white dark:bg-neutral-950 text-gray-800 dark:text-neutral-100 relative isolate antialiased">
          ...
          <div className="space-y-12 max-w-4xl mx-auto text-center">
            ...
            <div className="sm:flex-row flex flex-col gap-4 justify-center">
              ...
              <button
                ...
                className="inline-flex border border-zinc-300 dark:border-white/20 transition-colors hover:bg-gray-50 dark:hover:bg-neutral-800 dark:bg-neutral-900 items-center justify-center rounded-md bg-white px-8 py-3 font-medium"
              >
                See Example Work ↓
              </button>
            </div>
      ...
      <section className="max-w-7xl mx-auto px-8 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="p-6 rounded-2xl border border-zinc-200 dark:border-white/10 bg-white/50 dark:bg-white/5 space-y-4">
            ...
            <h3 className="text-xl font-semibold">Offload Anything You Don&apos;t Have Time For</h3>
            ...
            <div className="text-sm text-gray-600 dark:text-neutral-400 italic">
          ...
          <div className="p-6 rounded-2xl border border-zinc-200 dark:border-white/10 bg-white/50 dark:bg-white/5 space-y-4">
            ...
            <h3 className="text-xl font-semibold">Prototype Vague Ideas Quickly</h3>
            <p className="text-gray-700/80 dark:text-neutral-300/80">
          ...
          <div className="p-6 rounded-2xl border border-zinc-200 dark:border-white/10 bg-white/50 dark:bg-white/5 space-y-4">
            ...
            <h3 className="text-xl font-semibold">AI-Powered Workflow Automation</h3>
            <p className="text-gray-700/80 dark:text-neutral-300/80">
        ...
        <div className="grid md:grid-cols-4 gap-8">
          <div className="relative">
            <div className="text-center space-y-3">
              <div className="w-12 h-12 rounded-full bg-[#5E50A0] text-white flex items-center justify-center mx-auto font-semibold text-lg">
                1
              </div>
              <h3 className="font-semibold">Discovery Call (Free)</h3>
          ...
          <div className="relative">
            <div className="text-center space-y-3">
              ...
              <h3 className="font-semibold">Trial Week (20 hours)</h3>
              <p className="text-sm text-gray-700/80 dark:text-neutral-300/80">
          ...
          <div className="relative">
            <div className="text-center space-y-3">
              ...
              <h3 className="font-semibold">Evaluate Fit</h3>
              <p className="text-sm text-gray-700/80 dark:text-neutral-300/80">
      ...
      <section id="example-work" className="max-w-7xl mx-auto px-8 py-16">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="p-6 rounded-xl border border-zinc-200 dark:border-white/10 bg-white/50 dark:bg-white/5 space-y-3">
            <div className="text-sm font-medium text-[#5E50A0]">Product Development</div>
          ...
          <div className="p-6 rounded-xl border border-zinc-200 dark:border-white/10 bg-white/50 dark:bg-white/5 space-y-3">
            <div className="text-sm font-medium text-[#5E50A0]">Growth & GTM</div>
          ...
          <div className="p-6 rounded-xl border border-zinc-200 dark:border-white/10 bg-white/50 dark:bg-white/5 space-y-3">
            <div className="text-sm font-medium text-[#5E50A0]">AI Automation</div>
          ...
          <div className="p-6 rounded-xl border border-zinc-200 dark:border-white/10 bg-white/50 dark:bg-white/5 space-y-3">
            <div className="text-sm font-medium text-[#5E50A0]">Operations</div>
          ...
          <div className="p-6 rounded-xl border border-zinc-200 dark:border-white/10 bg-white/50 dark:bg-white/5 space-y-3">
            <div className="text-sm font-medium text-[#5E50A0]">Content & Marketing</div>
          ...
          <div className="p-6 rounded-xl border border-zinc-200 dark:border-white/10 bg-white/50 dark:bg-white/5 space-y-3">
            <div className="text-sm font-medium text-[#5E50A0]">Design & Dev</div>
      ...
      <section className="max-w-5xl mx-auto px-8 py-16">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          <div className="p-8 rounded-2xl border-2 border-zinc-200 dark:border-white/10 bg-white/50 dark:bg-white/5 space-y-4">
            <div className="space-y-2">
              <div className="text-sm font-medium text-[#5E50A0]">Strategic Work</div>
          ...
          <div className="p-8 rounded-2xl border-2 border-zinc-200 dark:border-white/10 bg-white/50 dark:bg-white/5 space-y-4">
            <div className="space-y-2">
              <div className="text-sm font-medium text-[#5E50A0]">Execution Work</div>
        ...
        <div className="p-6 rounded-xl bg-gradient-to-r from-[#5E50A0]/10 to-[#9b87f5]/10 border border-zinc-200 dark:border-white/10">
            ...
            <div ref={textAreaRef} className="md:col-span-2">
              <div className="bg-white dark:bg-neutral-900/50 rounded-2xl p-8 space-y-6 text-gray-800 dark:text-neutral-100">
                ...
                <div className="grid md:grid-cols-2 gap-4 pt-4">
                  <div className="bg-[#1B0A38] rounded-xl p-6">
